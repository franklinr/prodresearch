...
"resource": {
  ...
  "predicates":[{
      ...
      "function":"_cn",
      "arg0":["macro",3],
      "arg1":"sage-stag.literatumonline.com"
    },{
      "function":"_re",
      "arg0":["macro",8],
      "arg1":"(tde|aip|pdk)",
  ...
  "rules":[
    [["if",0,1,2],["add",0]],
    [["if",5,6,7,8],["add",1]],
    [["if",9,10],["unless",3],["add",2,5,20,21,43,104]],
    [["if",1,11,12],["add",3,6]],
    [["if",1,11,13],["add",3,6]],
    [["if",9,10,14],["add",4]],
    [["if",17,18],["add",7]],
    ...
    [["if",32],["add",15,16]],
    [["if",1,33,34],["add",17]],
    [["if",10],["add",18,33,89,96,45,49,50,51,52,53,54,55,57,64,67,68,69,70,76,77,78,79,80,81,82,83,86,88]],
    [["if",10,35],["add",19]],
    [["if",1,36,37],["add",22]],
    [["if",38],["add",23,92,117,108,109]],
    [["if",10,39],["add",24]],
    [["if",10,40],["add",25]],
    [["if",10,41],["add",26]],
    [["if",42,43,44],["add",27]],
    ...
    [["if",26,68],["add",40]],
    [["if",1,69,70],["add",41,111]],
    [["if",10,71],["add",42]],
    [["if",9,10],["unless",16],["add",46]],
    [["if",9,10,58],["add",47]],
    [["if",10,72],["add",48]],
    [["if",10,73],["add",56]],
    [["if",10,74],["add",58]],
    [["if",10,75],["add",59,66,99]],
    [["if",10,76],["add",60,100]],
    [["if",10,77],["add",61,100]],
    [["if",10,78],["unless",79],["add",62]],
    [["if",10,80],["add",63]],
    [["if",10,81,82],["add",65,99]],
    [["if",10,83],["add",71]],
    [["if",10,84],["add",72,84,85]],
    [["if",85],["add",73,87,91]],
    [["if",10,86],["add",74]],
    [["if",10,87],["add",75]],
    [["if",9,17,90],["add",90]],
    ...
    [["if",1,97,98],["add",98]],
    [["if",10,99],["add",99]],
    [["if",78,90,101],["unless",79],["add",100]],
    [["if",80,90],["add",100]],
    [["if",90,102],["unless",103,104],["add",100]],
    [["if",1,105,106],["add",101]],
    [["if",1,107,108],["add",101]],
    [["if",1,107,109],["add",101]],
    [["if",1,107,110],["add",101]],
    [["if",1,107,111],["add",101]],
    [["if",1,112,113],["add",101]],
    [["if",26,81,114],["add",102]],
    [["if",115,116],["add",102]],
    [["if",10,117],["add",102]],
    [["if",19,118],["add",103,105]],
    [["if",1,119,120],["add",106]],
    [["if",99,121,122],["add",107]],
    [["if",1,51,123],["add",107]],
    [["if",90,124],["add",108]],
    [["if",115,125],["add",110]],
    [["if",84,121,126],["add",112,113]],
    [["if",43,127],["add",114,115]],
    [["if",1,3,4],["block",0,3,6,8,13,17]],
    [["if",10,15],["block",4]],
    [["if",9,10,16],["block",5]],
    [["if",3,19],["block",7,9,10,12,18,19,24,25,26,94,95,96,99,100,101,102,103,107]],
    [["if",3,26],["block",11,14]],
    [["if",10,88],["block",89]],
    [["if",10,89],["block",89]],
    [["if",19,84,100],["block",99,100,101,102,107]]]
},
...
return null},hg=!1;if(K.querySelectorAll)try{var ig=K.querySelectorAll(":root");ig&&1==ig.length&&ig[0]==K.documentElement&&(hg=!0)}catch(a){}var eg=hg;var Ld={},O=null,wg=Math.random();Ld.C="GTM-5M58KS";Ld.Wb="871";Ld.ci="";var xg={__cl:!0,__ecl:!0,__ehl:!0,__evl:!0,__fal:!0,__fil:!0,__fsl:!0,__hl:!0,__jel:!0,__lcl:!0,__sdl:!0,__tl:!0,__ytl:!0,__paused:!0,__tg:!0},yg="www.googletagmanager.com/gtm.js";
var zg=yg,Ag=null,Bg=null,Cg="//www.googletagmanager.com/a?id="+Ld.C+"&cv=187",Dg={},Eg={},Fg=function(){var a=O.sequence||1;O.sequence=a+1;return a};
...
X.b.opt=["google"],function(){var a,b=function(c){var d={};if(c.vtp_gaSettings){var e=c.vtp_gaSettings;E(Sp(e.vtp_fieldsToSet,"fieldName","value"),d);c.vtp_gaSettings=null;e.vtp_fieldsToSet=void 0;var f=E(e);c=E(c,f)||{}}E(Sp(c.vtp_fieldsToSet,"fieldName","value"),d);var g=dk(c.vtp_functionName);if(Fa(g)){g.r=!0;var h="",l="";c.vtp_setTrackerName&&"string"===typeof c.vtp_trackerName?""!==c.vtp_trackerName&&(l=c.vtp_trackerName,h=l+"."):(l="gtm"+Fg(),h=l+".");var n={name:!0,clientId:!0,sampleRate:!0,
...
c.vtp_gtmOnFailure()},c.vtp_gtmOnFailure));var v=V("dataLayer"),w=v&&v.hide;w&&(w.end||!0===w["GTM-5M58KS"])&&(w[c.vtp_optimizeContainerId]=!0)}else N(c.vtp_gtmOnFailure)};X.__opt=b;X.__opt.g="opt";X.__opt.h=!0;X.__opt.priorityOverride=0}();
